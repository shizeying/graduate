<template>
  <div style="margin-top: 10px" v-loading="fullloading">
    <div style="margin-bottom: 10px;display: flex;justify-content: center;align-items: center">
      ...
      <el-button size="small" type="primary" @click="showAddMember" style="position: fixed;right: 50px;">添加成员</el-button>
    </div>
    ...
    <el-dialog
      ...
      <el-form label-width="80px">
        <el-form-item label="工号：">
          <el-input v-model="addMemberData.workID" size="mini" disabled></el-input>
        </el-form-item>
        <el-form-item label="姓名：">
          <el-select style="width: 100%" v-model="userIndex" size="mini" placeholder="请选择" :loading="selectLoading" @focus="getMemberList">
            <el-option
    ...
    computed: {
      addMemberData () {
        if(this.userIndex ==='') {
          ...
          return this.memberList[this.userIndex]
        }
      }
  },
    mounted: function () {
    ...
    methods: {
      getMemberList () {
        // if(this.memberList.length != 0) {
          ...
          this.postRequest('/system/hr/getMember').then(res => {
      ...
      confirmAddMember () {
        console.log(this.memberList[this.userIndex].name),
          console.log(this.memberList.address),
          console.log(this.memberList),
        this.postRequest('/system/hr/insert', {
          name: this.memberList[this.userIndex].name,
          address: this.memberList[this.userIndex].address,
          phone: this.memberList[this.userIndex].phone
